...
<body>
                ...
                <tbody>
                   ...
                   <?php foreach ($brands as $brand): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <input class="form-control" type="checkbox" <?php if ($brand->is_available) echo 'checked' ?> />
                        </td>
                        <td>
                            <input class="form-control" type="number" min="0" value="<?=$brand->sort_order;?>" />
                        </td>
                        ...
                        <td class="w-50-px">
                            <button data-id="<?=$brand->id;?>" type="button" class="btn btn-danger btn-delete">Delete</button>
                        </td>
                    </tr>
            ...
            notie.confirm(
            {
                ...
                {        
                    ...
                    function(operationStatus)
                    {
                        ...
                        if (operationStatus.isOperationSucceeded) load_view({entity_name: 'brands', page_number: page_number});
    ...
    {        
        ...
        {                  
            $.post("/moderator/brands/add/", 
            {
                name: $("#create table input[type='text']").val(),
                is_available: $("#create table input[type='checkbox']").is(":checked"),
                sort_order: $("#create table input[type='number']").val(),
                submit: true
            }, 
            function(operationStatus)
            {
                ...
                if (operationStatus.isOperationSucceeded) 
                {
                    ...
                    load_view({entity_name: 'brands', page_number: page_number});
                }
